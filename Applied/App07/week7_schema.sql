...
ALTER TABLE unit ADD CONSTRAINT chk_unit_name UNIQUE ( unit_name );
...
ALTER TABLE enrolment
    ADD CONSTRAINT enrol_pk PRIMARY KEY ( stu_nbr,
                                          unit_code,
                                          enrol_year,
                                          enrol_semester );
...
ALTER TABLE enrolment
    ADD CONSTRAINT chk_enr_sem CHECK ( enrol_semester IN ( 1, 2, 3 ) );